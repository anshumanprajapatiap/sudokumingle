...
class SudokuGeneratorUtil{
  ...
  SudokuGenerator() {
    grid = List.generate(9, (index) => List<int>.filled(9, 0));
    random = Random();
  }
  ...
  // Map<String, dynamic> generateSudoku(Difficulty difficulty){
  //   Random random = Random();
  //   String randomString = localSudokuListInString[random.nextInt(localSudokuListInString.length)];
  //
  //   <List<List<intcorrectSudoku = getSudokuFromString(randomString);
  //
...
void main() {
  final sudoku = SudokuGeneratorUtil();
