...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void rewardedAdFn() {
    RewardedAd.load(
        ...
        request: const AdRequest(
          keywords: ['game', 'rewarded', '10 seconds'],
          httpTimeoutMillis: 10,
  ...
  void showRewardedAd(BuildContext ctx) {
    final firebaseUserDataProviderReward =
        Provider.of<FirebaseUserDataProvider>(ctx, listen: false);
    if (rewardedAd != null) {
  ...
  void navigateToPlayWithFriendScreen(
      BuildContext context, Difficulty selectedDifficulty, String roomId) {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => PlayWithFriendScreen(
              difficultyLevel: selectedDifficulty, roomId: roomId)),
    );
  }
  ...
  Widget build(BuildContext context) {
    final firebaseUserDataProvider =
        Provider.of<FirebaseUserDataProvider>(context);
    final firebaseRoomManagementProvider =
        Provider.of<FirebaseRoomManagementProvider>(context, listen: false);
    return Scaffold(
      appBar: AppBar(
          ...
          Column(
            ...
            children: [
              SizedBox(
                ...
                child: firebaseUserDataProvider.getUserData['userFirstName'] ==
                        null
                    ? Center(
                        child: Text(
                          'Loading.....',
                    ...
                    : Row(
                        ...
                        children: [
                          ...
                          firebaseUserDataProvider.getUserData['userRank'] !=
                                  null
                              ? firebaseUserDataProvider
                                          .getUserData['userRank'] >
                                      999999
                                  ? Text(
                                      'Rank: 999999+',
                                      style: topHeading,
                          ...
                          firebaseUserDataProvider.getUserData['coins'] != null
                              ? firebaseUserDataProvider.getUserData['coins'] >
                                      999999
                                  ? Text(
                                      'Coins: 999999+',
                                      style: topHeading,
              ...
              ScrollableCarousel(
                cards: [
                  ...contestData
                      .map((data) => CardWidget(color: data['color'])),
                ],
                // cards: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      showDifficultyDialog(context)
                          .then((selectedDifficulty) async {
                        if (selectedDifficulty != null &&
                            selectedDifficulty != Difficulty.none) {
                          setState(() {
                            _isRoomLoading = true;
                          });
                          await firebaseRoomManagementProvider
                              .joinOrCreateRoomTesting(selectedDifficulty);
                          String rId = firebaseRoomManagementProvider
                          ...
                          navigateToPlayWithFriendScreen(
                              context, selectedDifficulty, rId);
                        }
                      });
                    },
                    child: Text(
                      ...
                      child: Center(
                        child: CircularProgressIndicator(
                            color: Theme.of(context)
                                .primaryColor), // You can replace this with your custom loading widget
                      ),
                    ),
                  ),
                ],
